...
final class DirectoryContentViewModel {
    ...
    var sortMode: SortMode {
        didSet {
            itemsToDisplay = DirectoryContentViewModel.itemsWithAppliedFilterAndSortCriterias(searchQuery: searchQuery ?? "",
                                                                                              sortMode: sortMode,
                                                                                              items: allItems)
    ...
    var searchQuery: String? = "" {
        willSet(newSearchQuery) {
            itemsToDisplay = DirectoryContentViewModel.itemsWithAppliedFilterAndSortCriterias(searchQuery: newSearchQuery ?? "",
                                                                                              sortMode: sortMode,
                                                                                              items: allItems)
        }
        didSet {
